          ...
          <Row>
            <Col>
              <div className="proPicCrop">
                <Image src="https://assets.dropcolumn.com/profiles/madmax.jpg" fluid className="proPic" />
              </div>
            </Col>
          </Row>
          <Row className="linkRow">
            <Col>
              <a href="https://soundcloud.com/maedmaex1" id="soundcloudBtn" className="socialButton" 
                type="button" rel="noopener noreferrer" target="_blank"><FaSoundcloud /></a>
              <a href="https://www.instagram.com/madmaxbeats_/" id="instagramBtn" className="socialButton" 
            ...
            <Col>
              <CardDeck className="profileCardDeck">
                <Card className="profileCard" id="profileCardTop">
                  <Card.Body>
                    <Card.Title as="h4" className="memberProfileCardTitle">mädmäx</Card.Title>
                    <Card.Text>
                      straight from the outerspace underground circa 1990
                    </Card.Text>
                  </Card.Body>
                </Card>
              </CardDeck>
