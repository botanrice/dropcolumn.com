          ...
          <Row>
            <Col>
              <div className="proPicCrop">
                <Image src="https://assets.dropcolumn.com/profiles/otoroshi.jpg" fluid className="proPic" />
              </div>
            </Col>
          </Row>
          <Row className="linkRow">
            <Col>
              <a href="https://soundcloud.com/otoroshi" id="soundcloudBtn" className="socialButton" 
                type="button" rel="noopener noreferrer" target="_blank"><FaSoundcloud /></a>
              <a href="https://www.instagram.com/donotoroshi/" id="instagramBtn" className="socialButton" 
            ...
            <Col>
              <CardDeck className="profileCardDeck">
                <Card className="profileCard" id="profileCardTop">
                  <Card.Body>
                    <Card.Title as="h4" className="memberProfileCardTitle">Otoroshi</Card.Title>
                    <Card.Text>
                      Estonian Monte Booker.
                    </Card.Text>
                  </Card.Body>
                </Card>
              </CardDeck>
