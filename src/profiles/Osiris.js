          ...
          <Row>
            <Col>
              <div className="proPicCrop">
                <Image src="https://assets.dropcolumn.com/profiles/osiris.png" fluid className="proPic" />
              </div>
            </Col>
          </Row>
          <Row className="linkRow">
            <Col>
              <a href="https://soundcloud.com/kingosirisj" id="soundcloudBtn" className="socialButton" 
                type="button" rel="noopener noreferrer" target="_blank"><FaSoundcloud /></a>
              <a href="https://www.instagram.com/kingosirisj/" id="instagramBtn" className="socialButton" 
