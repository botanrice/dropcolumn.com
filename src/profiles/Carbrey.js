          ...
          <Row>
            <Col>
              <div className="proPicCrop">
                <Image src="https://assets.dropcolumn.com/profiles/carbrey.png" fluid className="proPic" />
              </div>
            </Col>
          </Row>
          <Row className="linkRow">
            <Col>
              <a href="https://soundcloud.com/carbaeiry" id="soundcloudBtn" className="socialButton" 
            ...
            <Col>
              <CardDeck className="profileCardDeck">
                <Card className="profileCard" id="profileCardTop">
                  <Card.Body>
                    <Card.Title as="h4" className="memberProfileCardTitle">Carbrey</Card.Title>
                    <Card.Text>
                      smooth operator & slick lyricist coming off the dome straight to your area
                    </Card.Text>
                  </Card.Body>
                </Card>
              </CardDeck>
